...
Alternatively a Variable Watch can be programmed in the LUA Start Code module using, for example: 
luup.variable_watch("price_watch", "urn:micasaverde-com:serviceId:EnergyMetering1", "price", AgileDeviceId)
where price_watch is the function to be called when the value changes, and price is the variable to be watched.
